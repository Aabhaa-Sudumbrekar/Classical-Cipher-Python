...
def make_matrix(key,alphabet):
    """Generate the 5x5 Playfair key matrix from the supplied key."""
    key_final = []
...
def find_position(matrix,letter):
    """Find and return the row and column of a letter in the key matrix."""
...
def prepare_plaintext(plaintext):
    """Convert plaintext into Playfair digraphs and insert filler X when needed."""
...
def prepare_ciphertext(ciphertext):
    """Convert ciphertext into Playfair digraphs."""
...
def encrypt_text(matrix, pairs):
    """Encrypt all plaintext digraphs and return the ciphertext."""
    ciphertext = ""
    for pair in pairs:
...
def decrypt_text(matrix,pairs):
    """Decrypt all ciphertext digraphs and return the plaintext."""
    plaintext = ""
    for pair in pairs:
...
def encrypt_pair(matrix,pair):
    """Encrypt a single pair of characters using Playfair cipher rules."""
    first,second = pair
...
def decrypt_pair(matrix,pair):
    """Decrypt a single pair of characters using Playfair cipher rules."""
    first,second = pair
